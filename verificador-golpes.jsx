...
function analyzeText(text, hasLink) {
  ...
  if (CODE_REQUEST_RE.test(lower)) {
    flags.push({ label: `Pede para você informar/repassar um código de verificação — golpe comum de captura de código (alguém tentando entrar numa conta usando seu código)`, weight: "high" });
    score += 55;
  }
